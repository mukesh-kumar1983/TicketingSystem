...
describe('TicketService', () => {
  ...
  it('should not send a whitespace-only search parameter', () => {
    ...
    expect(httpRequest.request).toBeDefined();
    expect(httpRequest.request.method).toBe('GET');
  ...
  /**
   * Verifies that getTimeEntries uses the exact time-entry API path
  ...
  it('should use the supplied ticket id when retrieving time entries', () => {
    const url = `${timeEntriesApiUrl}/25/time-entries`;

    service.getTimeEntries(25).subscribe();
  ...
  /**
   * Verifies that getTimeEntries constructs the correct URL.
   */
  it('should construct the correct getTimeEntries URL', () => {
    const expectedUrl = `${timeEntriesApiUrl}/999/time-entries`;
  ...
  /**
   * Verifies that createTimeEntry constructs the correct URL.
   */
  it('should construct the correct createTimeEntry URL', () => {
    const expectedUrl = `${timeEntriesApiUrl}/999/time-entries`;

    service.createTimeEntry(999, createTimeEntryRequest()).subscribe();
